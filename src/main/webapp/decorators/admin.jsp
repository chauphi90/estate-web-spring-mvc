...
<link rel="stylesheet"
  href="${adminResource}/assets/css/bootstrap.min.css" />
<link rel="stylesheet"
  href="${adminResource}/font-awesome/4.5.0/css/font-awesome.min.css" />
<link rel="stylesheet"
  href="${adminResource}/assets/css/fonts.googleapis.com.css" />
<link rel="stylesheet" href="${adminResource}/assets/css/ace.min.css"
  class="ace-main-stylesheet" id="main-ace-style" />
<script type='text/javascript'
  src="${adminResource}/assets/js/ace-extra.min.js"></script>
<link rel="stylesheet"
...
<link rel="stylesheet"
  href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
<script type='text/javascript'
  src="${adminResource}/js/2.1.4/jquery.min.js"></script>
